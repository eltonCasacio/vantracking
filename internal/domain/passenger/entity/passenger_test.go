...
func TestNewPassenger(t *testing.T) {
	id := identity.NewID()
	p, err := NewPassenger("any_name", "any_routecode", id)
	assert.Nil(t, err)
...
func TestNewPassenge_InvalidName(t *testing.T) {
	p, err := NewPassenger("", "any_routecode", identity.NewID())
	assert.Nil(t, p)
	assert.NotNil(t, err)
...
func TestNewPassenge_InvalidRouteCode(t *testing.T) {
	p, err := NewPassenger("any_name", "", identity.NewID())
	assert.Nil(t, p)
	assert.NotNil(t, err)
...
func TestSetNickname(t *testing.T) {
	p, _ := NewPassenger("any_name", "any_routecode", identity.NewID())
...
func TestSetInvalidName(t *testing.T) {
	p, err := NewPassenger("any_name", "any_routecode", identity.NewID())
	assert.Nil(t, err)
